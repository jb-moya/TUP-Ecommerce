        ...
        <>
            <Stack className="review-container-stack">
                <Row className="review-container user-review">
                    <Col
                        className="main-review-body column"
                        md={{ span: 8, offset: 2 }}
                    >
                        <Row xs="auto">
                            ...
                            <Col className="column date ms-auto">
                                Apr 1, 2024
                            </Col>
                        </Row>
                        ...
                        <Row className="review-body">
                            ANG BAHO. Putangina diko na-enjoy. Pero dahil Horney
                            na horney nako ginamit ko parin. tiniis ko ung amoy.
                            pero sa bandang huli nakaramdam ako ng disgust at
                            emptiness. #neverAgain
                        </Row>
                        <Row
                            className="custom-row like-button-container"
                            xs="auto"
                        >
