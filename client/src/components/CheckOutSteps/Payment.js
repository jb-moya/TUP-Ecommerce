...
<div>
      ...
      <ul className='flex text-20 w-full h-70 justify-center'>
        <li className='p-4'>
          <button
            className={`text-${clickedButton === 0 ? 'blue' : 'gray'}-500 flex items-center justify-center rounded border w-[200px] h-[50px] ${clickedButton === 0 ? 'border-[#211C6A]' : 'border-gray-500'}  transform ${clickedButton === 0 ? 'scale-110' : ''}  duration-300 ease-in-out`}
        ...
        <li className='p-4'>
          <button
            className={`text-${clickedButton === 1 ? 'blue' : 'gray'}-500 border rounded w-[200px] h-[50px] ${clickedButton === 1 ? 'border-[#211C6A]' : 'border-gray-500'} transform ${clickedButton === 1 ? 'scale-110' : ''}  duration-300 ease-in-out`}
