      ...
      {/* College of Science Organizations */}
        ...
        >  
          ...
          <SwiperSlide key={item.title}>
            <div className="flex flex-col gap-6 mb-12 group relative shadow-lg text-white rounded-xl px-6 py-8 h-[250px] w-[215px] lg:h-[400px] lg:w-[350px] overflow-hidden cursor-pointer">
              <div
